...
<html>
    ...
    <a href="${pageContext.request.contextPath}/categoryUpdate.htm?categoryID=${category.categoryID}" class="btn btn-update" title="Edit">
        <i data-feather="edit"></i>
    </a>
    <a href="${pageContext.request.contextPath}/categoryDelete.htm?categoryID=${category.categoryID}" class="btn btn-delete" title="Delete" onclick="return confirm('Are you sure you want to delete this category?');">
