            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container mt-4">
                        <h2>Assign Shifts for Weekly Work Schedule</h2>
                        ...
                        <form action="${pageContext.request.contextPath}/admin/assignShift.htm" method="post">
                            <input type="hidden" name="weekScheduleID" value="${weekSchedule.weekScheduleID}" />
                            <div class="form-group">
                                <label for="weekScheduleID">Week Schedule:</label>
                                <select id="weekScheduleID" name="weekScheduleID" class="form-control">
                                    <c:forEach var="weekSchedule" items="${weekSchedules}">
                                        <option value="${weekSchedule.weekScheduleID}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="overtimeHours" name="overtimeHours" step="0.1" class="form-control" />
                            </div>
