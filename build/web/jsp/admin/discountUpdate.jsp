                ...
                <main class="content">
                    <div class="container mt-4">
                        ...
                        <table class="table table-hover my-0" id="discountTable">
                            <form action="${pageContext.request.contextPath}/discountUpdate.htm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="discountType" name="discountType" value="${discount.discountType}" required>
                                </div>
                                <div class="form-group">
                                        <label for="discountValue">Discount Value:</label>
                                        <input type="number" class="form-control" id="discountValue" name="discountValue"  value="${discount.discountValue}" step="0.01" required>
                                    </div>
                            ...
                            <!-- Example of using c:forEach if you had a list of discounts -->
