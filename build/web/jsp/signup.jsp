...
<html>
    <head>
        ...
        <style>
            ...
            /* Style cho các dòng trong form */
            .form-row {
                margin-bottom: 15px;
            }

            /* Sắp xếp các ô text thành hai cột */
            ...
            .form-row label {
                ...
                font-weight: bold;
                font-size: 14px;
                color: #000; /* Màu chữ đen cho nhãn */
            }

            /* Cải tiến cho các trường nhập liệu */
            .txt-input {
                width: 100%;
                padding: 12px;
            ...
            /* Cải tiến cho thông báo thành công và lỗi */
            ...
            /* Cải tiến cho liên kết trong form */
            .link-to-help {
                color: #ff9702;
            ...
            /* Cải tiến cho phần container của form */
            .form-container {
