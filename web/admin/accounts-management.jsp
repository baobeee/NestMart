<%-- 
    Document   : accounts-management
    Created on : Aug 16, 2024, 12:42:27 PM
    Author     : Win10
--%>
                        ...
                        <ul class="navbar-nav navbar-align">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="Accounts Managementaccounts-management.jsp"><i class="align-middle me-1" data-feather="users"></i> Accounts Management</a>
                        ...
                        <table class="table table-hover my-0" id="accountTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="date-format">15/01/1990</td>
                                    <td>0123456789</td>
                                    <td>123 Elm Street, Springfield</td>
                                    <td>25.500</td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                    </td>
                                </tr>
                                <!-- Employees -->
                                <tr>
                                    ...
                                    <td class="date-format">22/03/1985</td>
                                    <td>0987654321</td>
                                    <td>456 Oak Avenue, Springfield</td>
                                    <td>30.000</td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                ...
                                <tr>
                                    ...
                                    <td class="date-format">16/05/1995</td>
                                    <td>0333444555</td>
                                    <td>654 Birch Street, Springfield</td>
                                    <td>26.000</td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                ...
                                <tr>
                                    ...
                                    <td>Female</td>
                                    <td>Alice White</td>
                                    <td>alicewhite@example.com</td>
                                    <td class="date-format">05/11/1988</td>
                                    <td>0444555666</td>
                                    <td>321 Maple Street, Springfield</td>
                                    <td></td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                ...
                                <tr>
                                    ...
                                    <td class="date-format">20/12/1990</td>
                                    <td>0777888999</td>
                                    <td>987 Birch Avenue, Springfield</td>
                                    <td></td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                ...
                                <tr>
                                    ...
                                    <td>Non-binary</td>
                                    <td>Customer Name</td>
                                    <td>customer123@example.com</td>
                                    <td class="date-format">10/08/2000</td>
                                    <td>0666777888</td>
                                    <td>789 Maple Avenue, Springfield</td>
                                    <td></td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                ...
                                <tr>
                                    ...
                                    <td>Female</td>
                                    <td>Jane Customer</td>
                                    <td>customer456@example.com</td>
                                    <td class="date-format">12/07/1998</td>
                                    <td>0555666777</td>
                                    <td>654 Pine Street, Springfield</td>
                                    <td></td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
                                ...
                                <tr>
                                    ...
                                    <td>Male</td>
                                    <td>John Customer</td>
                                    <td>customer789@example.com</td>
                                    <td class="date-format">01/11/1995</td>
                                    <td>0444555666</td>
                                    <td>321 Oak Avenue, Springfield</td>
                                    <td></td>
                                    <td class="table-actions">
                                        <button class="btn btn-update"><i data-feather="edit"></i></button>
                                        <button class="btn btn-delete"><i data-feather="trash-2"></i></button>
