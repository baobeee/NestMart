                ...
                <div class="top-bar right">
                    <ul class="horizontal-menu">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="../nestmartFinal/login.htm" class="login-link">
                    ...
                    <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                        <div class="primary-menu">
                            <ul class="menu nestmart-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                    <li class="menu-item"><a href="../nestmartFinal/index.htm">Home</a>
                                ...
                                <li class="menu-item">
                                    <a href="../nestmartFinal/about.htm" class="menu-name" data-title="About">About</a>
                                </li>
                                <li class="menu-item">
                                    <a href="../nestmartFinal/viewNotifications.htm" class="menu-name" data-title="Notifications">Notification</a>
                                </li>
                                <li class="menu-item"><a href="../nestmartFinal/contact.html">Contact</a></li>
                                <li class="menu-item">
                                    <c:choose>
                                        <c:when test="${not empty sessionScope.email}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 padding-top-2px">
                        <div class="header-search-bar layout-01">
                            <form action="../nestmartFinal/client/product.htm" class="form-search" name="desktop-search" method="get">
