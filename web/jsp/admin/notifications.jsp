                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
                                    ...
                                    <div class="dropdown-menu-footer">
                                        <a href="#" class="text-muted">Show all notificationss</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                ...
                <main class="content">
                    <div class="container mt-4">
                        ...
                        <div class="search-container">
                            <form action="findNotifications.htm">
                                <table border="0">
                                    <tbody>
                                        <tr>
                                ...
                                <c:forEach var="notifications" items="${notificationsList}">
                                    <tr>
                                        ...
                                        <td class="table-actions">
                                            <!--<a href="${pageContext.request.contextPath}/updateInventory.htm?notificationID=${notifications.notificationID}" class="btn btn-update" title="Edit">
                                                <i data-feather="edit"></i>
                                            </a>-->
                                            <a href="${pageContext.request.contextPath}/deleteNotification.htm?notificationID=${notifications.notificationID}" class="btn btn-delete" title="Delete" onclick="return confirm('Are you sure you want to delete this notification information?');">
