                                ...
                                <form action="saveFeedbackResponse.htm" method="POST">
                                    <div class="form-group">
                                        <div class="product-container">
                                            <img src="../assets/admin/images/uploads/products/${feedbackdetails.productImage}" alt="alt" class="product-image"/>
                                    ...
                                    <div class="form-group">
                                        <img src="../assets/admin/images/uploads/products/${feedbackdetails.feedbackImage}" alt="alt" width="170px" height="auto"/>
                                    </div>
                                    <div class="form-group">
