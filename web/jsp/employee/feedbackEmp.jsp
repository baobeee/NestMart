            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container mt-4">
                        ...
                        <a href="feedbackWithoutResponse.htm" class="link-spacing">Feedback Without Response</a>
                            ...
                            <tbody>
                                <c:forEach var="feedback" items="${feedbacks}">
                                    <tr>
                                        ...
                                        <td><c:out value="${feedback.product.productID}" /></td>
                                        <td><c:out value="${feedback.product.productName}" /></td>
                                        ...
                                        <td>
                                            <img src="${pageContext.request.contextPath}/assets/admin/images/uploads/products/<c:out value="${feedback.feedbackImage}" />"
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${feedbackResponses[feedback.feedbackID] == null}">
                                                <form action="saveFeedbackResponse.htm" method="post">
                                                    ...
                                                    <!--                                                    <input type="hidden" name="employeeID" value=""/>  Assuming you're using Spring Security -->
                                                    <input type="hidden" name="employeeID" value="2"/>
                                                    <textarea name="responseContent" placeholder="Write your response here" required></textarea>
