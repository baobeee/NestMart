                                ...
                                <form action="${pageContext.request.contextPath}/client/createOrder.htm" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="paymentMethod" id="paymentMethodCOD" value="Cash on Delivery" checked>
                                            <label class="form-check-label" for="paymentMethodCOD">
                                                Cash on Delivery
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="paymentMethod" id="paymentMethodCard" value="Credit Card">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty cart}">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="../assets/client/images/uploads/products/${item.productImage}" 
                                                                         alt="${item.productName}" class="cart-image" style="width: 100px;
                                                                    height: auto;">
                                                                </td>
                                            ...
                                            <div class="text-right mt-3">
                                                <button type="submit" class="btnAddcart" style="margin-right: 23px;
                                                width: 100px">Order</button>
                                                </div>
                                            </c:when>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        function updateCartTotal() {
                            ...
                            rows.forEach(function (row) {
                                ...
                                // Nếu không có input quantity, sử dụng giá trị hiện tại
                            ...
                            // Cập nhật tổng số tiền vào thẻ span
                            document.getElementById('cart-total').textContent = total.toFixed(2);

                            // Cập nhật giá trị của trường hidden totalAmountInput
