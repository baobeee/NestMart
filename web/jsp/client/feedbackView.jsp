                    ...
                    <c:forEach var="feedback" items="${feedbacks}">
                        <div class="feedback-container">
                            <div class="feedback-item">
                                <div class="product-info product-container">
                                    <c:if test="${not empty feedback.product.images}">
                                        <img src="${pageContext.request.contextPath}/assets/client/images/uploads/products/${feedback.product.images[0].images}" alt="Product Image" class="product-image" width="400" height="400"/>
                                    </c:if>
                                        <div class="product-name">
                                    <h2 >${feedback.product.productName}</h2>
                                        </div>
                                ...
                                <div class="feedback-content">
                                    ...
                                    <c:if test="${not empty feedback.feedbackImage}">
                                        <img src="${pageContext.request.contextPath}/assets/client/images/uploads/products/${feedback.feedbackImage}" alt="${feedback.product.productName}" class="feedback-image"/>
                                    </c:if>

                                    <p class="feedback-date">${feedback.formattedFeedbackDate}</p>
                                </div>
                            </div>
                            <c:if test="${empty employeeReponses}">
                                <button class="ok-btn" onclick="window.history.back();">OK</button>
                            </c:if>
                            <c:if test="${not empty employeeReponses}">
                                <div class="responseContent">
                                    <b>NestMart's Response:</b> 
                                    <p>${employeeReponses.responseContent}</p>
                                </div>
