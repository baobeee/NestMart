...
<html lang="en" class="no-js">
    ...
    <style>
        ...
        .pagination .page-item.disabled .page-link {
         ...
         /* CSS cho danh sách sản phẩm trong phần Giảm giá */
.discount-section {
    margin-bottom: 40px; /* Khoảng cách giữa các phần giảm giá */
}

.discount-banner {
    width: 100%; /* Đảm bảo banner có chiều rộng 100% */
    height: auto; /* Chiều cao tự động */
    border-radius: 8px; /* Góc bo tròn cho banner */
...
.products-list {
    ...
    gap: 31px; /* Khoảng cách giữa các sản phẩm */
    padding: 40px; /* Padding cho danh sách sản phẩm */
}

/* Định dạng cho sản phẩm trong danh sách */
.product-item {
    list-style: none; /* Bỏ danh sách dấu chấm */
...
/* Điều chỉnh bố cục cho thiết bị nhỏ hơn */
                                ...
                                <div class="product-price-container">
                                    <c:choose>
                                        <c:when test="${product.discount > 0}">
                                            <p>
                                                <span class="original-price1" style="text-decoration: line-through; color: #888;">
                                                    £${product.unitPrice}
                                                </span>
                                                <span class="discounted-price1" style="color: red; font-weight: bold;">
                                                    £${product.discount}
                                                </span>
                                            </p>
                                        </c:when>
                                        <c:otherwise>
                                            <p class="original-price2" style="font-weight: bold;">
                                                £${product.unitPrice}
                                            </p>
                                        </c:otherwise>
                                    </c:choose>
