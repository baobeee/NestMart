            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10 col-sm-12">
                    <div class="form-container">
                        ...
                        <form action="${pageContext.request.contextPath}/resetPassword.htm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="email" name="email" class="txt-input" value="${email}" readonly />
                            </div>
                        ...
                        <div class="form-row wrap-btn">
                            <a href="${pageContext.request.contextPath}/login.htm" class="link-to-help">Back to Login</a>
                        </div>
                    </div>
                </div>
            </div>
